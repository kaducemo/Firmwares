...
/* UART4 interrupt handler identifier. */
#define UART4_SERIAL_RX_TX_IRQHANDLER UART4_RX_TX_IRQHandler
/* UART4 interrupt vector ID (number). */
#define UART4_SERIAL_ERROR_IRQN UART4_ERR_IRQn
/* UART4 interrupt handler identifier. */
#define UART4_SERIAL_ERROR_IRQHANDLER UART4_ERR_IRQHandler
/* Definition of peripheral ID */

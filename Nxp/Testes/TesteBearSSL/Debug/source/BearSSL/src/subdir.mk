...
C_SRCS += \
../source/BearSSL/src/settings.c 

C_DEPS += \
./source/BearSSL/src/settings.d 

OBJS += \
./source/BearSSL/src/settings.o 


# Each subdirectory must supply rules for building sources it contributes
source/BearSSL/src/%.o: ../source/BearSSL/src/%.c source/BearSSL/src/subdir.mk
	@echo 'Building file: $<'
...
clean: clean-source-2f-BearSSL-2f-src

clean-source-2f-BearSSL-2f-src:
	-$(RM) ./source/BearSSL/src/settings.d ./source/BearSSL/src/settings.o

.PHONY: clean-source-2f-BearSSL-2f-src

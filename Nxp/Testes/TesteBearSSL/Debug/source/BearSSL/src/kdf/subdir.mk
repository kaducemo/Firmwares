...
C_DEPS += \
./source/BearSSL/src/kdf/hkdf.d 

OBJS += \
./source/BearSSL/src/kdf/hkdf.o 


# Each subdirectory must supply rules for building sources it contributes
source/BearSSL/src/kdf/%.o: ../source/BearSSL/src/kdf/%.c source/BearSSL/src/kdf/subdir.mk
	@echo 'Building file: $<'
...
clean: clean-source-2f-BearSSL-2f-src-2f-kdf

clean-source-2f-BearSSL-2f-src-2f-kdf:
	-$(RM) ./source/BearSSL/src/kdf/hkdf.d ./source/BearSSL/src/kdf/hkdf.o

.PHONY: clean-source-2f-BearSSL-2f-src-2f-kdf

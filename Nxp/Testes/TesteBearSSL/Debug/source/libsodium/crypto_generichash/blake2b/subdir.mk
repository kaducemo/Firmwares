...
C_SRCS += \
../source/libsodium/crypto_generichash/blake2b/generichash_blake2.c 

C_DEPS += \
./source/libsodium/crypto_generichash/blake2b/generichash_blake2.d 

OBJS += \
./source/libsodium/crypto_generichash/blake2b/generichash_blake2.o 


# Each subdirectory must supply rules for building sources it contributes
source/libsodium/crypto_generichash/blake2b/%.o: ../source/libsodium/crypto_generichash/blake2b/%.c source/libsodium/crypto_generichash/blake2b/subdir.mk
	@echo 'Building file: $<'
...
clean: clean-source-2f-libsodium-2f-crypto_generichash-2f-blake2b

clean-source-2f-libsodium-2f-crypto_generichash-2f-blake2b:
	-$(RM) ./source/libsodium/crypto_generichash/blake2b/generichash_blake2.d ./source/libsodium/crypto_generichash/blake2b/generichash_blake2.o

.PHONY: clean-source-2f-libsodium-2f-crypto_generichash-2f-blake2b

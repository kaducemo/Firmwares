...
C_SRCS += \
../source/libsodium/crypto_pwhash/crypto_pwhash.c 

C_DEPS += \
./source/libsodium/crypto_pwhash/crypto_pwhash.d 

OBJS += \
./source/libsodium/crypto_pwhash/crypto_pwhash.o 


# Each subdirectory must supply rules for building sources it contributes
source/libsodium/crypto_pwhash/%.o: ../source/libsodium/crypto_pwhash/%.c source/libsodium/crypto_pwhash/subdir.mk
	@echo 'Building file: $<'
...
clean: clean-source-2f-libsodium-2f-crypto_pwhash

clean-source-2f-libsodium-2f-crypto_pwhash:
	-$(RM) ./source/libsodium/crypto_pwhash/crypto_pwhash.d ./source/libsodium/crypto_pwhash/crypto_pwhash.o

.PHONY: clean-source-2f-libsodium-2f-crypto_pwhash

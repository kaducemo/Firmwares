...
C_SRCS += \
../source/libsodium/crypto_verify/verify.c 

C_DEPS += \
./source/libsodium/crypto_verify/verify.d 

OBJS += \
./source/libsodium/crypto_verify/verify.o 


# Each subdirectory must supply rules for building sources it contributes
source/libsodium/crypto_verify/%.o: ../source/libsodium/crypto_verify/%.c source/libsodium/crypto_verify/subdir.mk
	@echo 'Building file: $<'
...
clean: clean-source-2f-libsodium-2f-crypto_verify

clean-source-2f-libsodium-2f-crypto_verify:
	-$(RM) ./source/libsodium/crypto_verify/verify.d ./source/libsodium/crypto_verify/verify.o

.PHONY: clean-source-2f-libsodium-2f-crypto_verify

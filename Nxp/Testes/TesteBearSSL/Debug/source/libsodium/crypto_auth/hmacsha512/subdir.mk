...
C_SRCS += \
../source/libsodium/crypto_auth/hmacsha512/auth_hmacsha512.c 

C_DEPS += \
./source/libsodium/crypto_auth/hmacsha512/auth_hmacsha512.d 

OBJS += \
./source/libsodium/crypto_auth/hmacsha512/auth_hmacsha512.o 


# Each subdirectory must supply rules for building sources it contributes
source/libsodium/crypto_auth/hmacsha512/%.o: ../source/libsodium/crypto_auth/hmacsha512/%.c source/libsodium/crypto_auth/hmacsha512/subdir.mk
	@echo 'Building file: $<'
...
clean: clean-source-2f-libsodium-2f-crypto_auth-2f-hmacsha512

clean-source-2f-libsodium-2f-crypto_auth-2f-hmacsha512:
	-$(RM) ./source/libsodium/crypto_auth/hmacsha512/auth_hmacsha512.d ./source/libsodium/crypto_auth/hmacsha512/auth_hmacsha512.o

.PHONY: clean-source-2f-libsodium-2f-crypto_auth-2f-hmacsha512

...
C_SRCS += \
../source/libsodium/crypto_auth/crypto_auth.c 

C_DEPS += \
./source/libsodium/crypto_auth/crypto_auth.d 

OBJS += \
./source/libsodium/crypto_auth/crypto_auth.o 


# Each subdirectory must supply rules for building sources it contributes
source/libsodium/crypto_auth/%.o: ../source/libsodium/crypto_auth/%.c source/libsodium/crypto_auth/subdir.mk
	@echo 'Building file: $<'
...
clean: clean-source-2f-libsodium-2f-crypto_auth

clean-source-2f-libsodium-2f-crypto_auth:
	-$(RM) ./source/libsodium/crypto_auth/crypto_auth.d ./source/libsodium/crypto_auth/crypto_auth.o

.PHONY: clean-source-2f-libsodium-2f-crypto_auth

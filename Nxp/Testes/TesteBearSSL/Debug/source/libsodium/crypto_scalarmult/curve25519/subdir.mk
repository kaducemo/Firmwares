...
C_SRCS += \
../source/libsodium/crypto_scalarmult/curve25519/scalarmult_curve25519.c 

C_DEPS += \
./source/libsodium/crypto_scalarmult/curve25519/scalarmult_curve25519.d 

OBJS += \
./source/libsodium/crypto_scalarmult/curve25519/scalarmult_curve25519.o 


# Each subdirectory must supply rules for building sources it contributes
source/libsodium/crypto_scalarmult/curve25519/%.o: ../source/libsodium/crypto_scalarmult/curve25519/%.c source/libsodium/crypto_scalarmult/curve25519/subdir.mk
	@echo 'Building file: $<'
...
clean: clean-source-2f-libsodium-2f-crypto_scalarmult-2f-curve25519

clean-source-2f-libsodium-2f-crypto_scalarmult-2f-curve25519:
	-$(RM) ./source/libsodium/crypto_scalarmult/curve25519/scalarmult_curve25519.d ./source/libsodium/crypto_scalarmult/curve25519/scalarmult_curve25519.o

.PHONY: clean-source-2f-libsodium-2f-crypto_scalarmult-2f-curve25519

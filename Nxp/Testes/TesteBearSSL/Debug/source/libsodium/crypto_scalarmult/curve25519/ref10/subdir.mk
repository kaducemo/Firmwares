...
C_SRCS += \
../source/libsodium/crypto_scalarmult/curve25519/ref10/x25519_ref10.c 

C_DEPS += \
./source/libsodium/crypto_scalarmult/curve25519/ref10/x25519_ref10.d 

OBJS += \
./source/libsodium/crypto_scalarmult/curve25519/ref10/x25519_ref10.o 


# Each subdirectory must supply rules for building sources it contributes
source/libsodium/crypto_scalarmult/curve25519/ref10/%.o: ../source/libsodium/crypto_scalarmult/curve25519/ref10/%.c source/libsodium/crypto_scalarmult/curve25519/ref10/subdir.mk
	@echo 'Building file: $<'
...
clean: clean-source-2f-libsodium-2f-crypto_scalarmult-2f-curve25519-2f-ref10

clean-source-2f-libsodium-2f-crypto_scalarmult-2f-curve25519-2f-ref10:
	-$(RM) ./source/libsodium/crypto_scalarmult/curve25519/ref10/x25519_ref10.d ./source/libsodium/crypto_scalarmult/curve25519/ref10/x25519_ref10.o

.PHONY: clean-source-2f-libsodium-2f-crypto_scalarmult-2f-curve25519-2f-ref10

...
C_SRCS += \
../source/libsodium/randombytes/internal/randombytes_internal_random.c 

C_DEPS += \
./source/libsodium/randombytes/internal/randombytes_internal_random.d 

OBJS += \
./source/libsodium/randombytes/internal/randombytes_internal_random.o 


# Each subdirectory must supply rules for building sources it contributes
source/libsodium/randombytes/internal/%.o: ../source/libsodium/randombytes/internal/%.c source/libsodium/randombytes/internal/subdir.mk
	@echo 'Building file: $<'
...
clean: clean-source-2f-libsodium-2f-randombytes-2f-internal

clean-source-2f-libsodium-2f-randombytes-2f-internal:
	-$(RM) ./source/libsodium/randombytes/internal/randombytes_internal_random.d ./source/libsodium/randombytes/internal/randombytes_internal_random.o

.PHONY: clean-source-2f-libsodium-2f-randombytes-2f-internal

...
C_SRCS += \
../source/libsodium/randombytes/randombytes.c 

C_DEPS += \
./source/libsodium/randombytes/randombytes.d 

OBJS += \
./source/libsodium/randombytes/randombytes.o 


# Each subdirectory must supply rules for building sources it contributes
source/libsodium/randombytes/%.o: ../source/libsodium/randombytes/%.c source/libsodium/randombytes/subdir.mk
	@echo 'Building file: $<'
...
clean: clean-source-2f-libsodium-2f-randombytes

clean-source-2f-libsodium-2f-randombytes:
	-$(RM) ./source/libsodium/randombytes/randombytes.d ./source/libsodium/randombytes/randombytes.o

.PHONY: clean-source-2f-libsodium-2f-randombytes

...
C_SRCS += \
../source/libsodium/randombytes/sysrandom/randombytes_sysrandom.c 

C_DEPS += \
./source/libsodium/randombytes/sysrandom/randombytes_sysrandom.d 

OBJS += \
./source/libsodium/randombytes/sysrandom/randombytes_sysrandom.o 


# Each subdirectory must supply rules for building sources it contributes
source/libsodium/randombytes/sysrandom/%.o: ../source/libsodium/randombytes/sysrandom/%.c source/libsodium/randombytes/sysrandom/subdir.mk
	@echo 'Building file: $<'
...
clean: clean-source-2f-libsodium-2f-randombytes-2f-sysrandom

clean-source-2f-libsodium-2f-randombytes-2f-sysrandom:
	-$(RM) ./source/libsodium/randombytes/sysrandom/randombytes_sysrandom.d ./source/libsodium/randombytes/sysrandom/randombytes_sysrandom.o

.PHONY: clean-source-2f-libsodium-2f-randombytes-2f-sysrandom

...
C_SRCS += \
../source/libsodium/crypto_sign/crypto_sign.c 

C_DEPS += \
./source/libsodium/crypto_sign/crypto_sign.d 

OBJS += \
./source/libsodium/crypto_sign/crypto_sign.o 


# Each subdirectory must supply rules for building sources it contributes
source/libsodium/crypto_sign/%.o: ../source/libsodium/crypto_sign/%.c source/libsodium/crypto_sign/subdir.mk
	@echo 'Building file: $<'
...
clean: clean-source-2f-libsodium-2f-crypto_sign

clean-source-2f-libsodium-2f-crypto_sign:
	-$(RM) ./source/libsodium/crypto_sign/crypto_sign.d ./source/libsodium/crypto_sign/crypto_sign.o

.PHONY: clean-source-2f-libsodium-2f-crypto_sign

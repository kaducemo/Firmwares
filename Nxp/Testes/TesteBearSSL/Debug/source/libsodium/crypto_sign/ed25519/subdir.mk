...
C_SRCS += \
../source/libsodium/crypto_sign/ed25519/sign_ed25519.c 

C_DEPS += \
./source/libsodium/crypto_sign/ed25519/sign_ed25519.d 

OBJS += \
./source/libsodium/crypto_sign/ed25519/sign_ed25519.o 


# Each subdirectory must supply rules for building sources it contributes
source/libsodium/crypto_sign/ed25519/%.o: ../source/libsodium/crypto_sign/ed25519/%.c source/libsodium/crypto_sign/ed25519/subdir.mk
	@echo 'Building file: $<'
...
clean: clean-source-2f-libsodium-2f-crypto_sign-2f-ed25519

clean-source-2f-libsodium-2f-crypto_sign-2f-ed25519:
	-$(RM) ./source/libsodium/crypto_sign/ed25519/sign_ed25519.d ./source/libsodium/crypto_sign/ed25519/sign_ed25519.o

.PHONY: clean-source-2f-libsodium-2f-crypto_sign-2f-ed25519

...
C_SRCS += \
../source/libsodium/crypto_hash/crypto_hash.c 

C_DEPS += \
./source/libsodium/crypto_hash/crypto_hash.d 

OBJS += \
./source/libsodium/crypto_hash/crypto_hash.o 


# Each subdirectory must supply rules for building sources it contributes
source/libsodium/crypto_hash/%.o: ../source/libsodium/crypto_hash/%.c source/libsodium/crypto_hash/subdir.mk
	@echo 'Building file: $<'
...
clean: clean-source-2f-libsodium-2f-crypto_hash

clean-source-2f-libsodium-2f-crypto_hash:
	-$(RM) ./source/libsodium/crypto_hash/crypto_hash.d ./source/libsodium/crypto_hash/crypto_hash.o

.PHONY: clean-source-2f-libsodium-2f-crypto_hash

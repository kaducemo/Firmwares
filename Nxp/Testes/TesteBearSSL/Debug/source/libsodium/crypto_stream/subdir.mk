...
C_SRCS += \
../source/libsodium/crypto_stream/crypto_stream.c 

C_DEPS += \
./source/libsodium/crypto_stream/crypto_stream.d 

OBJS += \
./source/libsodium/crypto_stream/crypto_stream.o 


# Each subdirectory must supply rules for building sources it contributes
source/libsodium/crypto_stream/%.o: ../source/libsodium/crypto_stream/%.c source/libsodium/crypto_stream/subdir.mk
	@echo 'Building file: $<'
...
clean: clean-source-2f-libsodium-2f-crypto_stream

clean-source-2f-libsodium-2f-crypto_stream:
	-$(RM) ./source/libsodium/crypto_stream/crypto_stream.d ./source/libsodium/crypto_stream/crypto_stream.o

.PHONY: clean-source-2f-libsodium-2f-crypto_stream

...
C_SRCS += \
../source/libsodium/crypto_stream/chacha20/stream_chacha20.c 

C_DEPS += \
./source/libsodium/crypto_stream/chacha20/stream_chacha20.d 

OBJS += \
./source/libsodium/crypto_stream/chacha20/stream_chacha20.o 


# Each subdirectory must supply rules for building sources it contributes
source/libsodium/crypto_stream/chacha20/%.o: ../source/libsodium/crypto_stream/chacha20/%.c source/libsodium/crypto_stream/chacha20/subdir.mk
	@echo 'Building file: $<'
...
clean: clean-source-2f-libsodium-2f-crypto_stream-2f-chacha20

clean-source-2f-libsodium-2f-crypto_stream-2f-chacha20:
	-$(RM) ./source/libsodium/crypto_stream/chacha20/stream_chacha20.d ./source/libsodium/crypto_stream/chacha20/stream_chacha20.o

.PHONY: clean-source-2f-libsodium-2f-crypto_stream-2f-chacha20

...
C_SRCS += \
../source/libsodium/crypto_aead/aes256gcm/aead_aes256gcm.c 

C_DEPS += \
./source/libsodium/crypto_aead/aes256gcm/aead_aes256gcm.d 

OBJS += \
./source/libsodium/crypto_aead/aes256gcm/aead_aes256gcm.o 


# Each subdirectory must supply rules for building sources it contributes
source/libsodium/crypto_aead/aes256gcm/%.o: ../source/libsodium/crypto_aead/aes256gcm/%.c source/libsodium/crypto_aead/aes256gcm/subdir.mk
	@echo 'Building file: $<'
...
clean: clean-source-2f-libsodium-2f-crypto_aead-2f-aes256gcm

clean-source-2f-libsodium-2f-crypto_aead-2f-aes256gcm:
	-$(RM) ./source/libsodium/crypto_aead/aes256gcm/aead_aes256gcm.d ./source/libsodium/crypto_aead/aes256gcm/aead_aes256gcm.o

.PHONY: clean-source-2f-libsodium-2f-crypto_aead-2f-aes256gcm

...
C_SRCS += \
../source/libsodium/crypto_aead/aes256gcm/aesni/aead_aes256gcm_aesni.c 

C_DEPS += \
./source/libsodium/crypto_aead/aes256gcm/aesni/aead_aes256gcm_aesni.d 

OBJS += \
./source/libsodium/crypto_aead/aes256gcm/aesni/aead_aes256gcm_aesni.o 


# Each subdirectory must supply rules for building sources it contributes
source/libsodium/crypto_aead/aes256gcm/aesni/%.o: ../source/libsodium/crypto_aead/aes256gcm/aesni/%.c source/libsodium/crypto_aead/aes256gcm/aesni/subdir.mk
	@echo 'Building file: $<'
...
clean: clean-source-2f-libsodium-2f-crypto_aead-2f-aes256gcm-2f-aesni

clean-source-2f-libsodium-2f-crypto_aead-2f-aes256gcm-2f-aesni:
	-$(RM) ./source/libsodium/crypto_aead/aes256gcm/aesni/aead_aes256gcm_aesni.d ./source/libsodium/crypto_aead/aes256gcm/aesni/aead_aes256gcm_aesni.o

.PHONY: clean-source-2f-libsodium-2f-crypto_aead-2f-aes256gcm-2f-aesni

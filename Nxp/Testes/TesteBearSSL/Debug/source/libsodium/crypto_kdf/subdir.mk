...
C_SRCS += \
../source/libsodium/crypto_kdf/crypto_kdf.c 

C_DEPS += \
./source/libsodium/crypto_kdf/crypto_kdf.d 

OBJS += \
./source/libsodium/crypto_kdf/crypto_kdf.o 


# Each subdirectory must supply rules for building sources it contributes
source/libsodium/crypto_kdf/%.o: ../source/libsodium/crypto_kdf/%.c source/libsodium/crypto_kdf/subdir.mk
	@echo 'Building file: $<'
...
clean: clean-source-2f-libsodium-2f-crypto_kdf

clean-source-2f-libsodium-2f-crypto_kdf:
	-$(RM) ./source/libsodium/crypto_kdf/crypto_kdf.d ./source/libsodium/crypto_kdf/crypto_kdf.o

.PHONY: clean-source-2f-libsodium-2f-crypto_kdf

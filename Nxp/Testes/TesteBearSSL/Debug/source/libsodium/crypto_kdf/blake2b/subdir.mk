...
C_SRCS += \
../source/libsodium/crypto_kdf/blake2b/kdf_blake2b.c 

C_DEPS += \
./source/libsodium/crypto_kdf/blake2b/kdf_blake2b.d 

OBJS += \
./source/libsodium/crypto_kdf/blake2b/kdf_blake2b.o 


# Each subdirectory must supply rules for building sources it contributes
source/libsodium/crypto_kdf/blake2b/%.o: ../source/libsodium/crypto_kdf/blake2b/%.c source/libsodium/crypto_kdf/blake2b/subdir.mk
	@echo 'Building file: $<'
...
clean: clean-source-2f-libsodium-2f-crypto_kdf-2f-blake2b

clean-source-2f-libsodium-2f-crypto_kdf-2f-blake2b:
	-$(RM) ./source/libsodium/crypto_kdf/blake2b/kdf_blake2b.d ./source/libsodium/crypto_kdf/blake2b/kdf_blake2b.o

.PHONY: clean-source-2f-libsodium-2f-crypto_kdf-2f-blake2b

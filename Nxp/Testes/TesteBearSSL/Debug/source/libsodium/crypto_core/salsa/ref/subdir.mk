...
C_SRCS += \
../source/libsodium/crypto_core/salsa/ref/core_salsa_ref.c 

C_DEPS += \
./source/libsodium/crypto_core/salsa/ref/core_salsa_ref.d 

OBJS += \
./source/libsodium/crypto_core/salsa/ref/core_salsa_ref.o 


# Each subdirectory must supply rules for building sources it contributes
source/libsodium/crypto_core/salsa/ref/%.o: ../source/libsodium/crypto_core/salsa/ref/%.c source/libsodium/crypto_core/salsa/ref/subdir.mk
	@echo 'Building file: $<'
...
clean: clean-source-2f-libsodium-2f-crypto_core-2f-salsa-2f-ref

clean-source-2f-libsodium-2f-crypto_core-2f-salsa-2f-ref:
	-$(RM) ./source/libsodium/crypto_core/salsa/ref/core_salsa_ref.d ./source/libsodium/crypto_core/salsa/ref/core_salsa_ref.o

.PHONY: clean-source-2f-libsodium-2f-crypto_core-2f-salsa-2f-ref
